class virtual atom (name : string) (sym : string) (a_nb : int) =
object (self)
	method name = name
	method symbol = sym
	method atomic_number = a_nb

	method to_string = self#name ^ "atom, symbol : " ^ self#symbol ^ " atomic number : " ^ (string_of_int self#atomic_number)
...
class aluminium = object inherit atom "Aluminium" "Al" 13 end
class silicon = object inherit atom "Silicon" "Si" 14 end
class phophorus = object inherit atom "Phophorus" "P" 15 end
...
class neptinium = object inherit atom "Neptinium" "Np" 93 end
...
class darmstadtium = object inherit atom "Darmstadtium" "Ds" 110 end
class roentgenium = object inherit atom "Roentgenium" "Rg" 111 end
class copernicium = object inherit atom "Copernicium" "Cn" 112 end
class nihonium = object inherit atom "Nihonium" "Nh" 113 end
class flerovium = object inherit atom "Flerovium" "Fl" 114 end
class moscovium = object inherit atom "Moscovium" "Mc" 115 end
class livermorium = object inherit atom "Livermorium" "Lv" 116 end
class tennessine = object inherit atom "Tennessine" "Ts" 117 end
class oganesson = object inherit atom "Oganesson" "Og" 118 end
